            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <input class="form-control datetime" type="text" name="start_time" id="start_time" value="{{ request()->input('start_time') }}" placeholder="{{ trans('cruds.booking.fields.start_time') }}" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <input class="form-control datetime" type="text" name="end_time" id="end_time" value="{{ request()->input('end_time') }}" placeholder="{{ trans('cruds.booking.fields.end_time') }}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
...
@section('scripts')
<script>
$('#bookRoom').on('show.bs.modal', function (booking) {
    var button = $(booking.relatedTarget);
